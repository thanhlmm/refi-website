...
function PricingPanel({ plan, originalPrice, price, description, bullets, cta, ctaAction }) {

  return (
    <div className="w-64 w-full max-w-sm mx-auto mt-12 border border-gray-100 rounded shadow h-120 md:w-1/3" data-aos="fade-up">
      ...
      <h2 className="px-6 py-2 text-lg font-semibold">What's included?</h2>
